...
// which is the wrong skeleton shape for a form. page.tsx is now an async
// Server Component (real item/locations reads), so Next suspends on it and
// this fallback genuinely shows while that resolves.
