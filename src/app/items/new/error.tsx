...
// household/locations reads are real Supabase calls now and throw into this
// boundary on failure. Uses `retry` — see items/[id]/error.tsx's comment for
// why that's preferred over `reset` here.
export default function Error({
  ...
  return (
    <main className="flex flex-1 flex-col items-center justify-center p-6">
      <EmptyState
        title="Couldn't load the add-item form"
        titleAs="h1"
