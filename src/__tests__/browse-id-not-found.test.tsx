...
test("renders a deliberate not-found state with a real heading and a working way back to Browse", () => {
  render(<NotFound />);

  expect(screen.getByRole("heading", { level: 1, name: "Location not found" })).toBeDefined();
